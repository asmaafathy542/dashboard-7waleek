                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
                        ...
                        <div style={{ gridColumn: "1 / -1" }}>
                            ...
                            <div style={{ position: "relative" }}>
                                ...
                                <button onClick={() => setShowPass((p) => !p)} style={{ position: "absolute", right: "10px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", fontSize: "16px", color: "var(--icon-muted)", lineHeight: 1 }}>
                                    {showPass ? "🙈" : "👁"}
                                </button>
                            </div>
                        </div>
